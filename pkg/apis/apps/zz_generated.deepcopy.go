...
func (in *CanaryPauseStrategy) DeepCopyInto(out *CanaryPauseStrategy) {
	*out = *in
	if in.PauseNum != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CanaryPauseStrategy.
func (in *CanaryPauseStrategy) DeepCopy() *CanaryPauseStrategy {
	if in == nil {
		return nil
	}
	out := new(CanaryPauseStrategy)
	in.DeepCopyInto(out)
	return out
}
